...
{
    public static string saveDir = Application.dataPath + "/ToluaFramework/Scripts/Framework/Wrap/";
    public static string toluaBaseType = Application.dataPath + "/ToluaFramework/Scripts/Framework/BaseType/";
    public static string baseLuaDir = Application.dataPath + "/ToluaFramework/Tolua/Lua/";
    public static string injectionFilesPath = Application.dataPath + "/ToluaFramework/Scripts/Framework/Injection/";
